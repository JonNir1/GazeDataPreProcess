...
from LWS.scripts.check_proximity_to_target import check_proximity_for_gaze_data
...
def process_trial(trial: LWSTrial, sr: float, screen_monitor: ScreenMonitor = None, **kwargs):
    ...
    is_close_to_target = check_proximity_for_gaze_data(trial, screen_monitor, cnfg.THRESHOLD_VISUAL_ANGLE)
