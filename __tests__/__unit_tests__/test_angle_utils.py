...
class TestUtils(unittest.TestCase):
    ...
    def test_calculate_visual_angle(self):
        ...
        self.assertEqual(45, angle_utils.calculate_visual_angle_old(p1=(0, 0), p2=(0, 1), d=d, pixel_size=sm.pixel_size,
                                                                    use_radians=False))
        self.assertEqual(45, angle_utils.calculate_visual_angle_old(p1=(0, 0), p2=(1, 0), d=d, pixel_size=sm.pixel_size,
                                                                    use_radians=False))
        self.assertAlmostEqual(70.528779366, angle_utils.calculate_visual_angle_old(p1=(0, 0), p2=(2, 2), d=d,
                                                                                    pixel_size=sm.pixel_size,
                                                                                    use_radians=False))

        # plausible values
        d = 65
        sm = ScreenMonitor(width=53.5, height=31, resolution=(1920, 1080), refresh_rate=60)
        self.assertAlmostEqual(0.0247416922, angle_utils.calculate_visual_angle_old(p1=(0, 1), p2=(1, 1), d=d,
                                                                                    pixel_size=sm.pixel_size,
                                                                                    use_radians=False))
        self.assertAlmostEqual(0.0247416922,
                               angle_utils.calculate_visual_angle_old(p1=(1, 2), p2=(1, 1), d=d,
                                                                      pixel_size=sm.pixel_size, use_radians=False))
        self.assertAlmostEqual(0.0349900345,
                               angle_utils.calculate_visual_angle_old(p1=(0, 0), p2=(1, 1), d=d,
                                                                      pixel_size=sm.pixel_size, use_radians=False))
